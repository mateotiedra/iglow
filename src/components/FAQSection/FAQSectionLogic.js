...
const FAQSectionLogic = () => {
  const questions = [
    {
      title:
        'When and how will I receive my IGLOW smart jacket after supporting the campaign?',
      details:
    ...
    {
      title: 'What inspired the creation of the IGLOW smart jacket?',
      details:
    ...
    },
    {
      ...
      details:
        'The IGLOW smart jacket is designed to make users of all types of bikes, whether cargo bikes, powerful e-bikes or conventional bikes, highly visible thanks to its integrated LEDs, reflective strips and Bluetooth remote control. Drawing on their experience in the fashion industry, the designers have ensured that every aspect of the jacket combines functionality, comfort, lightness and aesthetics for maximum safety, day and night.',
    },
    {
      title: 'What are the features and benefits of the IGLOW smart jacket?',
      details:
    ...
    {
      title: 'How is IGLOW different from other safety smart jacket ?',
      details:
        "In addition to being equipped with brake lights and turn signals for cyclists, the IGLOW vest is versatile and can be used in various situations. It's perfect for evening or early morning runners  to ensure you're seen, and it can also be used in case of a roadside breakdown to signal your presence with its built-in warning lights. The IGLOW smart jacket is unique and designed to accompany you every day, providing both safety and style wherever you go.",
    },
    {
    ...
    {
      title:
        'Why is the IGLOW smart jacket so affordable given that it’s made in Switzerland?',
      details:
        'The affordable price of the IGLOW smart jacket is an exceptional offer exclusively for Indiegogo contributors. Normally, the price is higher, but we have deliberately set this attractive price to allow as many people as possible to benefit from using IGLOW. Our goal is to make the IGLOW smart jacket a global reference in safety. By producing locally in Switzerland, we ensure top-notch quality, combining advanced technology, safety, and style at a price point that’s truly a rare opportunity.',
    },
  ];
